...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="topicsUserMonitorCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-user-chbah-monitor" class="btn btn-big">Add Monitor</button>
                </div>
            </form>
