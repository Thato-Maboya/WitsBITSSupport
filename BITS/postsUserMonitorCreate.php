...
<head>
    ...
    <title>Admin Section - Add HJH Monitors</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Add HJH Monitor</h2>
            ...
            <form action="postsUserMonitorCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-user-hjh-monitor" class="btn btn-big">Add Monitor</button>
                </div>
            </form>
