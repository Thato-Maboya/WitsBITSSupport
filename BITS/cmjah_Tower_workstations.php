            ...
            <table>
                ...
                <?php foreach ($cmjah_workstations as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="usersTowerEdit.php?cmjahTower_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="cmjah_Tower_workstations.php?cmjahTower_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
