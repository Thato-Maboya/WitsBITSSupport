...
<head>
    ...
    <title>Admin Section - Manage HJH Tower's</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage HJH Tower's</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($hjh_workstations as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="postsTowerEdit.php?hjhTower_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="hjh_Tower_workstations.php?hjhTower_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
