...
<head>
    ...
    <title>Admin Section - Edit CMJAH Monitors</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Edit CMJAH Monitor</h2>
            ...
            <form action="usersUserMonitorEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-user-cmjah-monitor" class="btn btn-big">Update Monitor</button>
                </div>
            </form>
