...
<head>
    ...
    <title>Admin Section - Add CMJAH Towers</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Add CMJAH Tower</h2>
            ...
            <form action="usersUserTowerCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-user-cmjah-workstation" class="btn btn-big">Add Tower</button>
                </div>
            </form>
