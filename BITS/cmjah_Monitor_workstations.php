...
<head>
    ...
    <title>Admin Section - Manage CMJAH Monitor's</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage CMJAH Moniotor's</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($cmjah_workstations_monitor as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="usersMonitorEdit.php?cmjahMonitor_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="cmjah_Monitor_workstations.php?cmjahMonitor_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
