...
<head>
    ...
    <title>Admin Section - Edit CHBAH Towers</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Edit CHBAH Tower</h2>
            ...
            <form action="topicsUserTowerEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div>
                        <button type="submit" name="update-user-chbah-workstation" class="btn btn-big">Update Tower</button>
                    </div>
            </form>
