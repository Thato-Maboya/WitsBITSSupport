    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <div class="left-sidebar">
                <ul>
                    <li><a href="postsUserTowerCreate.php" class="btn btn-big">Add HJH Tower</a></li>
                    <li><a href="postsUserMonitorCreate.php" class="btn btn-big">Add HJH Monitor</a></li>
                    <li><a href="postsUserPrinterCreate.php" class="btn btn-big">Add HJH Printer</a></li>
                </ul>
            </div>
