...
$sql = "SELECT SUM(replaced_toner) as count, YEAR(created_at) as yr FROM hjh 
...
$hjh_year = json_encode(array_column($toners, 'yr'), JSON_NUMERIC_CHECK);
...
$sql = "SELECT SUM(replaced_toner) as count, YEAR(created_at) as yr FROM cmjah 
...
$cmjah_year = json_encode(array_column($toners_cmjah, 'yr'), JSON_NUMERIC_CHECK);
...
$sql = "SELECT SUM(replaced_toner) as count, YEAR(created_at) as yr FROM chbah 
...
$chbah_year = json_encode(array_column($toners_chbah, 'yr'), JSON_NUMERIC_CHECK);
