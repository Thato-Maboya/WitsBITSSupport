...
<head>
    ...
    <title>Admin Section - Manage Item</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage User or Office Items Records</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($individual_data as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="teamEdit.php?team_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="teamIndex.php?team_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
