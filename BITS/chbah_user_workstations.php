    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <div class="left-sidebar">
                <ul>
                    <li><a href="chbah_user_Tower_workstations.php" class="btn btn-big">Manage CHBAH Tower's</a></li>
                    <li><a href="chbah_user_Monitor_workstations.php" class="btn btn-big">Manage CHBAH Monitor's</a></li>
                    <li><a href="chbah_user_Printer_workstations.php" class="btn btn-big">Manage CHBAH Printer's</a></li>
                </ul>
            </div>
