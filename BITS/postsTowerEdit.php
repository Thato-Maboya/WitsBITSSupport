...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="postsTowerEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-hjh-workstation" class="btn btn-big">Update Tower</button>
                </div>
            </form>
