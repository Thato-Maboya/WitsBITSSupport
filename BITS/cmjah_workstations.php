    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <div class="left-sidebar">
                <ul>
                    <li><a href="cmjah_Tower_workstations.php" class="btn btn-big">Manage CMJAH Tower's</a></li>
                    <li><a href="cmjah_Monitor_workstations.php" class="btn btn-big">Manage CMJAH Monitor's</a></li>
                    <li><a href="cmjah_Printer_workstations.php" class="btn btn-big">Manage CMJAH Printer's</a></li>
                </ul>
            </div>
