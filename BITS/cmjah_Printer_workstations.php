...
<head>
    ...
    <title>Admin Section - Manage CMJAH Printer's</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage CMJAH Printer's</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($cmjah_workstations_printer as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="usersPrinterEdit.php?cmjahPrinter_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="cmjah_Printer_workstations.php?cmjahPrinter_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
