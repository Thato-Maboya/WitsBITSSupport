...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="postsPrinterEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-hjh-printer" class="btn btn-big">Update Printer</button>
                </div>
            </form>
