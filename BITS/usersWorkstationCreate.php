    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <div class="left-sidebar">
                <ul>
                    <li><a href="usersTowerCreate.php" class="btn btn-big">Add CMJAH Tower</a></li>
                    <li><a href="usersMonitorCreate.php" class="btn btn-big">Add CMJAH Monitor</a></li>
                    <li><a href="usersPrinterCreate.php" class="btn btn-big">Add CMJAH Printer</a></li>
                </ul>
            </div>
