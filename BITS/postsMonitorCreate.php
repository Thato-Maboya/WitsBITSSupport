...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="postsMonitorCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-hjh-monitor" class="btn btn-big">Add Monitor</button>
                </div>
            </form>
