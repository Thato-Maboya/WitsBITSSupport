    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <div class="left-sidebar">
                <ul>
                    <li><a href="hjh_Tower_workstations.php" class="btn btn-big">Manage HJH Tower's</a></li>
                    <li><a href="hjh_Monitor_workstations.php" class="btn btn-big">Manage HJH Monitor's</a></li>
                    <li><a href="hjh_Printer_workstations.php" class="btn btn-big">Manage HJH Printer's</a></li>
                </ul>
            </div>
