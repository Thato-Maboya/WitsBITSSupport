...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="usersUserPrinterEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-user-cmjah-printer" class="btn btn-big">Update Printer</button>
                </div>
            </form>
