...
<head>
    ...
    <title>Admin Section - Manage HJH Workstations</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage HJH Workstations</h2>

            <div class="left-sidebar">
                <ul>
                    <li><a href="hjh_user_Tower_workstations.php" class="btn btn-big">Manage HJH Tower's</a></li>
                    <li><a href="hjh_user_Monitor_workstations.php" class="btn btn-big">Manage HJH Monitor's</a></li>
                    <li><a href="hjh_user_Printer_workstations.php" class="btn btn-big">Manage HJH Printer's</a></li>
                </ul>
            </div>
