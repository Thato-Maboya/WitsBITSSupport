...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="topicsMonitorEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-chbah-monitor" class="btn btn-big">Update Monitor</button>
                </div>
            </form>
