...
<head>
    ...
    <title>Admin Section - Edit HJH Monitors</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Edit HJH Monitor</h2>
            ...
            <form action="postsMonitorEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-user-hjh-monitor" class="btn btn-big">Update Monitor</button>
                </div>
            </form>
