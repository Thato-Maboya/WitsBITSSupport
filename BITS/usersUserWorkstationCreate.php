...
<head>
    ...
    <title>Admin Section - Add CMJAH Workstations</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Add CMJAH Workstation</h2>

            <div class="left-sidebar">
                <ul>
                    <li><a href="usersUserTowerCreate.php" class="btn btn-big">Add CMJAH Tower</a></li>
                    <li><a href="usersUserMonitorCreate.php" class="btn btn-big">Add CMJAH Monitor</a></li>
                    <li><a href="usersUserPrinterCreate.php" class="btn btn-big">Add CMJAH Printer</a></li>
                </ul>
            </div>
