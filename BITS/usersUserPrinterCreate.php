...
<head>
    ...
    <title>Admin Section - Add CMJAH Printers</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Add CMJAH Printer</h2>
            ...
            <form action="usersUserPrinterCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-user-cmjah-printer" class="btn btn-big">Add Printer</button>
                </div>
            </form>
