...
<head>
    ...
    <title>Admin Section - Manage CHBAH Printer's</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage CHBAH Printer's</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($chbah_workstations_printer as $key => $record): ?>
                    <tr>
                        <td><?php echo $key + 1; ?></td>
                        <td><?php echo $record['username']; ?></td>
                        <td><?php echo $record['ward']; ?></td>
                        <td><?php echo $record['printer_name']; ?></td>
                        <td><?php echo $record['serial_number']; ?></td>
                        <td><?php echo $record['assets_number']; ?></td>
                        <td><?php echo $record['created_at']; ?></td>
                        <td><a href="topicsPrinterEdit.php?chbahPrinter_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="chbah_Printer_workstations.php?chbahPrinter_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
