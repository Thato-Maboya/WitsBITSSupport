...
<head>
    ...
    <title>Admin Section - Manage CHBAH</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage CHBAH Records</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($chbah_data as $key => $record): ?>
                    <tr>
                        <td><?php echo $key + 1; ?></td>
                        <td><?php echo $record['username']; ?></td>
                        <td><?php echo $record['ward']; ?></td>
                        <td><?php echo $record['type_of_toner']; ?></td>
                        <td><?php echo $record['quality_of_paper']; ?></td>
                        <td><?php echo $record['specify_issue']; ?></td>
                        <td><?php echo $record['created_at']; ?></td>
                        <td><a href="topicsEdit.php?chbah_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="topicsIndex.php?chbah_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
