...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="usersTowerEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-cmjah-workstation" class="btn btn-big">Update Tower</button>
                </div>
            </form>
