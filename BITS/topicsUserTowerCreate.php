...
<head>
    ...
    <title>Admin Section - Add CHBAH Towers</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Add CHBAH Tower</h2>
            ...
            <form action="topicsUserTowerCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-user-chbah-workstation" class="btn btn-big">Add Tower</button>
                </div>
            </form>
