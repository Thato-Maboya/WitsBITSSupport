...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="topicsTowerEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" name="update-chbah-workstation" class="btn btn-big">Update Tower</button>
                </div>
            </form>
