...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="topicsTowerCreate.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <button type="submit" name="create-chbah-workstation" class="btn btn-big">Add Tower</button>
                </div>
            </form>
