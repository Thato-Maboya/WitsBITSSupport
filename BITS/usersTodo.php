...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        <div class="button-group">
            <a href="usersTodoCreate.php" class="btn btn-big">Add List</a>
            <a href="usersTodo.php" class="btn btn-big">Manage Lists</a>
        </div>
            ...
            <table>
                ...
                <?php foreach ($todo_data as $key => $list): ?>
                    <tr>
                        ...
                        <?php if($list['done']): ?>
                            <td><a href="usersTodo.php?user_done=0&user_done_id=<?php echo $list['id']; ?>" class="publish">done</a></td>
                        <?php else: ?>
                            <td><a href="usersTodo.php?user_done=1&user_done_id=<?php echo $list['id']; ?>" class="unpublish">not done</a></td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
                </tbody>
