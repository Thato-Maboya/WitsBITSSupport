...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage HJH Records</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($hjh_data as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="postsEdit.php?hjh_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="postsIndex.php?hjh_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
