    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form action="teamEdit.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="computer" class="text-input">
                        ...
                        <?php if($computer_name == 'lg PC'): ?>
                            ...
                            <option value="rain wifi">Rain Wifi</option>
                        <?php endif; ?>
                        <?php if($computer_name == 'samsung PC'): ?>
                            <option value="samsung PC">Samsung PC</option>
                            <option value="hp PC">HP PC</option>
                            <option value="acer PC">Acer PC</option>
                            <option value="asus PC">Asus PC</option>
                ...
                <div>
                    <button type="submit" name="update-team" class="btn btn-big">Update Info</button>
                </div>
            </form>
