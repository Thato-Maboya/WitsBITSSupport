...
<head>
    ...
    <title>Admin Section - Manage HJH Monitor's</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage HJH Moniotor's</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($hjh_workstations_monitor as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="postsMonitorEdit.php?hjhMonitor_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="hjh_Monitor_workstations.php?hjhMonitor_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
