    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <div class="left-sidebar">
                <ul>
                    <li><a href="topicsTowerCreate.php" class="btn btn-big">Add CHBAH Tower</a></li>
                    <li><a href="topicsMonitorCreate.php" class="btn btn-big">Add CHBAH Monitor</a></li>
                    <li><a href="topicsPrinterCreate.php" class="btn btn-big">Add CHBAH Printer</a></li>
                </ul>
            </div>
