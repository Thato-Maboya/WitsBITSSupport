...
<head>
    ...
    <title>Admin Section - Manage CHBAH Tower's</title>
</head>
<body>
...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <h2 class="page-title">Manage CHBAH Tower's</h2>
            ...
            <table>
                ...
                <tbody>
                <?php foreach ($chbah_workstations as $key => $record): ?>
                    <tr>
                        ...
                        <td><a href="topicsTowerEdit.php?chbahTower_update_id=<?php echo $record['id']; ?>" class="edit">edit</a></td>
                        <td><a href="chbah_Tower_workstations.php?chbahTower_delete_id=<?php echo $record['id']; ?>" class="delete">delete</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
